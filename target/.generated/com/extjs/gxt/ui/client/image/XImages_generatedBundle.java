...
public class XImages_generatedBundle implements com.extjs.gxt.ui.client.image.XImages {
  private static final String IMAGE_BUNDLE_URL = GWT.getModuleBaseURL() + "C1D447933F4F19AFC29FFEBA101ABAC9.cache.png";
    private static final ClippedImagePrototype checked_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 606, 0, 16, 16);
    ...
    private static final ClippedImagePrototype field_invalid_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 574, 0, 16, 16);
    public com.google.gwt.user.client.ui.AbstractImagePrototype field_invalid() {
      return field_invalid_SINGLETON;
    }
    private static final ClippedImagePrototype grid_columns_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 590, 0, 16, 16);
    public com.google.gwt.user.client.ui.AbstractImagePrototype grid_columns() {
      return grid_columns_SINGLETON;
    }
    private static final ClippedImagePrototype grid_groupBy_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 526, 0, 16, 16);
    public com.google.gwt.user.client.ui.AbstractImagePrototype grid_groupBy() {
      return grid_groupBy_SINGLETON;
    }
    private static final ClippedImagePrototype grid_sortAsc_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 494, 0, 16, 16);
    public com.google.gwt.user.client.ui.AbstractImagePrototype grid_sortAsc() {
      return grid_sortAsc_SINGLETON;
    }
    private static final ClippedImagePrototype grid_sortDesc_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 478, 0, 16, 16);
    public com.google.gwt.user.client.ui.AbstractImagePrototype grid_sortDesc() {
      return grid_sortDesc_SINGLETON;
    }
    private static final ClippedImagePrototype group_checked_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 510, 0, 16, 16);
    ...
    private static final ClippedImagePrototype tree_folder_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 542, 0, 16, 16);
    public com.google.gwt.user.client.ui.AbstractImagePrototype tree_folder() {
      return tree_folder_SINGLETON;
    }
    private static final ClippedImagePrototype tree_folder_closed_SINGLETON = new ClippedImagePrototype(IMAGE_BUNDLE_URL, 558, 0, 16, 16);
